...
module.exports.name = "SR helpers";
...
module.exports.getGdocUrlCdn = require("./src/get_gdoc_url");
...
module.exports.isSRiframe = document.referrer.match(/^https?:\/\/(www.)?(\w+.)?lanacion.com.ar/);
